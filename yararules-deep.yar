...
rule Potential_Malware_ddos_botnet
{
		meta:
		author = "MageMojo"
			description = "backdoor file editor?"
		strings:
			$1="r0b0t Dd0s Php V.01" nocase
			$2="r0b0t Dd0s" nocase
			$3="UDP Flood" nocase
			$4="UDP Flooding" nocase
			$5="Completed with $packets" nocase
			$6="Host: <br><input type=text name=host><br>" nocase
			$7="Length (seconds): <br><input type=text name=time><br>" nocase
			$8="r0b0t" nocase
		condition:
			any of them

}
rule PHP_malware_base64spam
{
		meta:
		author = "MageMojo"
			description = "finds multiple base64 encodes in a row, typically malware, within a string only within first 1000 offset of a file aka the top"
		strings:
			$1= "base64_decode("
			$2= "round("
		condition:
			$1 in (0..1000)and (#1 > 5 or #2 > 5)
...
rule Potential_Malware_Bad_Strings
{
meta:
		author = "MageMojo"
		strings:
			$3="phpFileManager" nocase
			$4="dulldusk@gmail.com"
			$5="cracktype"
			$6="InboX Mass Mailer" nocase
$string1 = "v0pCr3w"
	$string2 = "BENJOLSHELL"
	$string3 = "EgY_SpIdEr"
	$string4 = "<title>HcJ"
...
rule Potential_Malware_suspicious_PHP
{
meta:
		author = "MageMojo"
    strings:
        ...
        $pr = /(preg_replace(_callback)?|mb_ereg_replace|preg_filter)\s*\(['"]\/[^\/]*\/e['"]/  // http://php.net/manual/en/function.preg-replace.php ### commented out due to false pos 
        ...
        /* Removed due to flagging Magento 2 $user_function = /(call_user_func|create_function)/ */
...
rule Potential_Malware_suspicious_strings
{
meta:
		author = "MageMojo"
    strings:
        ...
        $ = /\/bin\/(ba)?sh/ fullword
        $ = /hack(ing|er)/ nocase
        $vbs = /languages*=s*vbscript/ nocase
...
rule ajax
{
	meta:
		author = "MageMojo"
		description = "php_malware - file ajax.php"
		hash = "a7c648ad38e61017b1f35693c8b5690571cc6800a4c3bdf890a4fddc0f9ce0fc"
	strings:
		$s0 = "@$GLOBALS[$GLOBALS['vd6f182d'][50].$GLOBALS['vd6f182d'][51].$GLOBALS['vd6f182d'][57].$GLOBALS['vd6f182d'][57]](0);" fullword ascii
		$s1 = "$GLOBALS[$GLOBALS['vd6f182d'][55].$GLOBALS['vd6f182d'][90].$GLOBALS['vd6f182d'][81].$GLOBALS['vd6f182d'][49].$GLOBALS['vd6f182d'" ascii
		$s2 = "$GLOBALS[$GLOBALS['vd6f182d'][43].$GLOBALS['vd6f182d'][45].$GLOBALS['vd6f182d'][2].$GLOBALS['vd6f182d'][51].$GLOBALS['vd6f182d']" ascii
		$s3 = "elseif ($k6c2fa[$GLOBALS['vd6f182d'][25]] == $GLOBALS['vd6f182d'][81])" fullword ascii
		$s4 = "if ($k6c2fa[$GLOBALS['vd6f182d'][25]] == $GLOBALS['vd6f182d'][54])" fullword ascii
		$s5 = "eval($k6c2fa[$GLOBALS['vd6f182d'][90]]);" fullword ascii
		$s6 = "function i903a1d0b($k6c2fa, $gba9)" fullword ascii
		$s7 = "function ea3a77($k6c2fa, $gba9)" fullword ascii
		$s8 = "$o807a92ce = $gba9;" fullword ascii
		$s9 = "$o807a92ce = NULL;" fullword ascii
		$s10 = "$k6c2fa = $zda0;" fullword ascii
		$s11 = "$i4bcee = Array(" fullword ascii
		$s12 = "$p955e2dea = \"\";" fullword ascii
		$s13 = "global $me0d393a;" fullword ascii
		$s14 = "return $p955e2dea;" fullword ascii
	condition:
		uint16(0) == 0x3f3c and filesize < 41KB and all of them
}
rule sql
{
	meta:
...
rule Potential_Malware_dangerous_php
{
meta:
		author = "MageMojo"
 strings:
...
rule php_obfuscators
{
meta:
		author = "MageMojo"
 description="searches for fopo.com.ar"
strings:
$1="Free Online PHP Obfuscator"
$2="fopo.com.ar"
condition:
any of them
